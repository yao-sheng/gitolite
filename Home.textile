...
bq. _Side note: please don't expect responses if you use github's messaging interface to contact me.  Not even for a pull request.  I prefer email.  See bottom of this page for more on this._
...
**Please do NOT use github's messaging interface to contact me.  Or rather, don't expect me to respond if you do.  This includes pull requests (if you want me to pull something, give me a git:// URL and a branch name and I'll do it from the command line).**
