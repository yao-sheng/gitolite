...
How *NOT* to reach me: Please don’t send me messages via github's "issues" system, linkedin comments/discussion, stackoverflow questions, google+ "streams", and any other Web 3.0 "coolness".  Also, please don't send me pull requests via github.  The only thing I will accept is an email saying what URL and what branch to pull.
